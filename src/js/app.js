App = {
    ...
    initWeb3: function () {
        ...
        if (typeof web3 !== 'undefined') {
            ...
            ethereum.enable().then(function (msg) {
    ...
    // with data from the smart contract. For now, we list the candidates
    // we created inside the smart contract. We do this by looping through
    // each candidate in the mapping and rendering it to the table.
